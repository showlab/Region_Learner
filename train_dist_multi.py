...
if __name__ == '__main__':
    ...
    options = [
        ...
        CustomArgs(['--CLU'], type=bool, target=('arch', 'args', 'video_params', 'CLU')),
        CustomArgs(['--CLU_num_tokens'], type=int, target=('arch', 'args', 'video_params', 'CLU_num_tokens')),

        
        # CustomArgs(['--CLU_att'], type=bool, target=('arch', 'args', 'video_params', 'att')),
        # CustomArgs(['--CLU_not_plus'], type=bool, target=('arch', 'args', 'video_params', 'not_plus')),
        # CustomArgs(['--CLU_selecting'], type=bool, target=('arch', 'args', 'video_params', 'CLU_selecting')),
        # CustomArgs(['--CLU_selecting_start'], type=int, target=('arch', 'args', 'video_params', 'CLU_selecting_start')),
        CustomArgs(['--CLU_learn_region'], type=bool, target=('arch', 'args', 'video_params', 'CLU_learn_region')),
        CustomArgs(['--CLU_learn_region_num'], type=int, target=('arch', 'args', 'video_params', 'CLU_learn_region_num')),
        CustomArgs(['--CLU_region_att'], type=str, target=('arch', 'args', 'video_params', 'CLU_region_att')),
        CustomArgs(['--CLU_region_att_deepth'], type=bool, target=('arch', 'args', 'video_params', 'CLU_region_att_deepth')),
        # CustomArgs(['--CLU_build_tube'], type=bool, target=('arch', 'args', 'video_params', 'CLU_build_tube')),
        # CustomArgs(['--CLU_VTAlign'], type=bool, target=('arch', 'args', 'video_params', 'CLU_VTAlign')),
        ...
        # CustomArgs(['--debug'], type=bool, target=('trainer', 'debug'))
        # CustomArgs(['--vis_saving'], type=bool, target=('arch', 'args', 'video_params', 'vis_saving'))
    ...
    # # added by Mr. Yan
    # # append two args when two dataset are fed in.
    # if ('cc' in args.parse_known_args()[0].config) and ('web' in args.parse_known_args()[0].config):
    #     options.extend(
    #         [
    #         CustomArgs(['--bs_1', '--batch_size_1'], type=int, target=('data_loader', 1, 'args', 'batch_size')),
    #         CustomArgs(['--num_workers_1'], type=int, target=('data_loader', 1, 'args', 'num_workers')),
