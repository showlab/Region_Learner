...
class HMDB(TextVideoDataset):
    """
    WebVid Dataset.
    Assumes HMDB51 data is structured as follows.
    HMDB51/
        videos/
    ...
    def _get_caption(self, sample):
        ...
        if self.split=='train':
            ...
            # return f"{action}, a video of action"
            # return f"this is {action}, a video of action"
            # return f"human action of {action}"
            # return f"A video of {action}"
            # return f"A person is {action}"
            # return f"He is {action}"
